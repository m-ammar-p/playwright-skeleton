...
public class ConfigFileReader {
    ...
    static {
        ...
        String propertiesFilePath = Paths.get(System.getProperty("user.dir"), "profiles", "env", environment, "company.properties").toString();
    ...
    public static String getApplicationUrl() {
        String url = properties.getProperty("urlPoulta");
        if (url != null) return url;
        else
            throw new CompanyException("urlPoulta not specified in the properties file.");
    }
